...
v2 FIXES:
  ...
  - 1.8 RFU bloom threshold (WHO Alert Level 1, McQuaid et al. / Zamyadi et al. 2023)
...
def compute_ecological_ratios(df):
    """Molar N:P ratio using measured nitrate (SUNA) and SRP."""
    # NO3M_suna is already in umol/L
    N_umol = df['nitrate_umol']

    # SRP: convert ug P/L to umol P/L (MW of P = 30.97)
...
# =============================================================================
# 6. BLOOM LABELING (1.8 RFU - WHO Alert Level 1)
# =============================================================================
...
# v2 uses 1.8 RFU, which corresponds to WHO Alert Level 1 for the YSI EXO2
...
def label_blooms(df):
    """Label bloom/no-bloom using phycocyanin threshold of 1.8 RFU.
...
def export_to_excel(
    ...
    output_path='results/ess_results.xlsx'
):
    """
...
# =============================================================================
# 12. MAIN PIPELINE - v2 multi-year
# =============================================================================
...
def run_pipeline(file_pairs):
    ...
    print("Labeling bloom events (1.8 RFU, WHO Alert Level 1)...")
    df = label_blooms(df)
...
if __name__ == '__main__':
    ...
    file_pairs = [
        ...
        ('data/2016-2018 Lake Erie Water Data/2017 bloom dataset.csv',
         'data/2016-2018 Lake Erie Water Data/WE08_2017_annual_summary_phosphate.csv'),
    ...
    print("  3 years | 1.8 RFU threshold | convergence features")
